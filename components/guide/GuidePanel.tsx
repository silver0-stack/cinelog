...
const UNIVERSE_QA: QA[] = [
  { q: '영화들이 왜 이 자리에 있어?', a: '가까이 있을수록 관계가 깊어. 같은 감독, 겹치는 장르·테마, 또는 직접 연결해둔 사이일수록 가까워져.' },
  { q: '제목 밑에 보이는 평점/메모는 뭐야?', a: '그 영화에 남긴 감상 미리보기야. 눌러서 전체를 볼 수 있어.' },
  { q: '눌러보면?', a: '그 영화 카드가 화면 중앙에 크게 떠. 뒤집으면 평점/메모가 보이고, "이 영화를 중심으로"를 누르면 그 영화 기준으로 우주 전체가 다시 배치돼. 배경을 누르면 닫혀.' },
