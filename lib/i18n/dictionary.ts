...
const ko: Dict = {
  ...
  'settings.faqIntro': '자주 묻는 질문을 확인하세요',
  'settings.contactCta': '이메일로 문의하기',
  'nav.language': '언어',
  'nav.signOut': '로그아웃',
  'nav.exit': '← 나가기',
  'nav.recenter': '처음으로',
...
const en: Dict = {
  ...
  'addMenu.text': 'Add text',
  'nav.account': 'Account',
  'nav.settings': 'Settings',
  'settings.contact': 'Contact',
  'settings.faqIntro': 'Check the frequently asked questions',
  'settings.contactCta': 'Contact by email',
